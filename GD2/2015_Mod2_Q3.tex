...
\begin{enumerate}
\begin{framed}
Given a model involving a parameter , suppose that the likelihood obtained from a set of data is given by L( ) but no simple expression can be found for the maximum likelihood estimate
ˆ
 .
\end{framed}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(4)
1 2 , , , X X Xn
is a random sample from a population with probability density function
 
2 3
3 3
3
