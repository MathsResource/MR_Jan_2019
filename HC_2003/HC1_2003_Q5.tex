...
(approximately)
\[P (\lambda - 1.96 \sqrt{ \frac{\lambda}{n}} \leq \; \bar{X} \; \leq \;\lambda + 1.96 \sqrt{ \frac{\lambda}{n}})  =  0.95\]
...
\begin{framed}
A random sample of 400 observations yields Σxi = 2500. Calculate an
approximate 95\% confidence interval for $\lambda$. Given further that Σxi
2 = 25600,
