...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{framed}
4. (i) The continuous random variable X is distributed with probability density
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\[f(x) =  \alpha (1-x)^{\alpha-1}, \qquad \mbox{ where }0 < x < 1, 0 \alpha  > 0 .
...
\newpage
\begin{framed}
(ii) A random sample x1, x2, …, xn is taken from this distribution with a view to
...
α
α
as a function of α and n. Assuming that
αˆ is approximately Normally distributed with mean α and variance
2 ( )
1 2
2
log , , ..., |
