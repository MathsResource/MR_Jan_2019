...
(i) Let X denote the underlying random variable, with pdf ()/1xfxeμμ−=. So the likelihood function is ()/11,...,inxnniLxxeμμ−−==Π and 1loglog/niiLnxμμ==−−Σ.
...
(ii) The value of the estimate ˆμ is 2989.8x=.
